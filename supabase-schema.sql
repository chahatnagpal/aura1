...
VALUES
    ...
    ('ba111111-1111-1111-1111-111111111101', 'Silk Satin Scrunchie Set (Pack of 5)', 'silk-satin-scrunchie-set-5', 'Premium soft silk satin hair scrunchies designed to prevent hair breakage and creasing. Comes in a chic pastel palette: Blush Pink, Champagne, Sage Green, Vanilla, and Muted Mauve.', 'c1111111-1111-1111-1111-111111111111', 650, 950, 45, 5, TRUE, TRUE, FALSE, 4.9, 38),
    ('ba111111-1111-1111-1111-111111111102', 'French Matte Claw Clip Trio', 'french-matte-claw-clip-trio', 'Durable non-slip rectangular claw clips made with eco-friendly acrylic and heavy-duty alloy springs. Perfect for all hair lengths and everyday casual styling.', 'c1111111-1111-1111-1111-111111111111', 599, 850, 30, 5, TRUE, FALSE, TRUE, 4.8, 24),
    ('ba111111-1111-1111-1111-111111111103', 'Retro Vintage Oval Sunglasses', 'retro-vintage-oval-sunglasses', 'Timeless 90s aesthetic oval sunglasses with UV400 protective lenses. Lightweight frame offering maximum comfort and instant effortless chic.', 'c1111111-1111-1111-1111-111111111111', 1199, 1699, 18, 4, FALSE, TRUE, FALSE, 4.7, 19),

    -- 2. Aesthetic Jewelry
    ('ba222222-2222-2222-2222-222222222201', 'Dainty Gold Pearl Pendant Necklace', 'dainty-gold-pearl-pendant-necklace', '18K gold-plated stainless steel chain with a genuine freshwater baroque mini pearl pendant. Hypoallergenic, tarnish-resistant, and water-friendly for daily wear.', 'c2222222-2222-2222-2222-222222222222', 1250, 1800, 25, 5, TRUE, TRUE, FALSE, 5.0, 52),
    ('ba222222-2222-2222-2222-222222222202', 'Chunky Twisted Croissant Hoop Earrings', 'chunky-twisted-croissant-hoops', 'Bestselling French Parisian style croissant ribbed hoop earrings in 18K gold finish. Extremely lightweight, comfortable for all-day wear without weighing down ears.', 'c2222222-2222-2222-2222-222222222222', 950, 1400, 35, 6, TRUE, FALSE, TRUE, 4.9, 41),
    ('ba222222-2222-2222-2222-222222222203', 'Celestial Moon & Star Layered Choker', 'celestial-moon-star-layered-choker', 'Two-in-one layered gold chain featuring a delicate crescent moon and cubic zirconia star charms. Adjustable length with lobster clasp.', 'c2222222-2222-2222-2222-222222222222', 1399, 1999, 12, 4, FALSE, TRUE, FALSE, 4.8, 17),
    ('ba222222-2222-2222-2222-222222222204', 'Minimalist Stacking Rings (Set of 6)', 'minimalist-stacking-rings-set-6', 'Curated set of 6 dainty stacking rings in textured, twisted, and signet designs. Mix and match across fingers for an understated aesthetic look.', 'c2222222-2222-2222-2222-222222222222', 850, 1200, 22, 5, TRUE, FALSE, TRUE, 4.6, 29),

    -- 3. Beauty & Skincare Tools
    ('ba333333-3333-3333-3333-333333333301', 'Natural Rose Quartz Gua Sha & Roller Duo', 'rose-quartz-gua-sha-roller-duo', 'Handcrafted 100% authentic Brazilian rose quartz facial roller and heart-shaped Gua Sha stone. Helps reduce facial puffiness, boost lymphatic drainage, and enhance serum absorption.', 'c3333333-3333-3333-3333-333333333333', 1499, 2200, 15, 3, TRUE, TRUE, FALSE, 4.9, 46),
    ('ba333333-3333-3333-3333-333333333302', 'Velvet Cloud Makeup Sponge Trio with Case', 'velvet-cloud-makeup-sponge-trio', 'Ultra-soft microfiber blender sponges that double in size when damp. Delivers an airbrushed, streak-free foundation and concealer finish with minimal product absorption.', 'c3333333-3333-3333-3333-333333333333', 750, 1100, 40, 8, FALSE, FALSE, TRUE, 4.7, 33),
    ('ba333333-3333-3333-3333-333333333303', 'Travel Makeup Brush Set with Leather Case (8 Pcs)', 'travel-makeup-brush-set-8-pcs', 'Compact set of 8 ultra-soft vegan synthetic makeup brushes with champagne gold ferrules, packaged in a travel-ready cylindrical magnetic case.', 'c3333333-3333-3333-3333-333333333333', 1850, 2500, 14, 4, TRUE, FALSE, FALSE, 4.9, 21),

    -- 4. Bags & Organizers
    ('ba444444-4444-4444-4444-444444444401', 'Aesthetic Corduroy Shoulder Tote Bag', 'aesthetic-corduroy-tote-bag', 'Spacious soft corduroy tote bag with magnetic snap closure and interior zip pocket. Fits a 13-inch laptop, planner, water bottle, and daily makeup essentials.', 'c4444444-4444-4444-4444-444444444444', 1650, 2250, 20, 5, TRUE, TRUE, FALSE, 4.8, 35),
    ('ba444444-4444-4444-4444-444444444402', 'Quilted Puffer Cosmetic Pouch', 'quilted-puffer-cosmetic-pouch', 'Cloud-soft quilted travel pouch with smooth gold zipper. Water-resistant lining inside, ideal for carrying everyday makeup, lip glosses, and skincare bottles.', 'c4444444-4444-4444-4444-444444444444', 899, 1300, 28, 5, FALSE, FALSE, TRUE, 4.7, 18),
    ('ba444444-4444-4444-4444-444444444403', 'Portable Travel Jewelry Box Organizer', 'portable-travel-jewelry-box-organizer', 'Luxurious PU leather compact jewelry case with soft velvet interior. Compartments for rings, necklaces, stud earrings, and bracelets with zip-around protection.', 'c4444444-4444-4444-4444-444444444444', 1299, 1899, 16, 4, TRUE, FALSE, FALSE, 5.0, 42),

    -- 5. Cute Stationery & Gifts
    ('ba555555-5555-5555-5555-555555555501', 'Aesthetic Hardcover Bullet Journal & Pen', 'aesthetic-hardcover-bullet-journal-pen', '160 GSM thick bleed-proof dotted pages with a ribbon bookmark, expandable inner pocket, and gold metallic matching gel pen. Perfect for journaling and study notes.', 'c5555555-5555-5555-5555-555555555555', 999, 1450, 32, 6, FALSE, TRUE, TRUE, 4.8, 27),
    ('ba555555-5555-5555-5555-555555555502', 'Pastel Aesthetic Highlighter Set (6 Colors)', 'pastel-aesthetic-highlighter-set-6', 'Soft mild-liner highlighters with dual chisel tips. No bleed-through on standard book pages. Ideal for study aesthetics, bullet journaling, and gift packages.', 'c5555555-5555-5555-5555-555555555555', 550, 799, 50, 10, FALSE, FALSE, TRUE, 4.9, 39),

    -- 6. Home & Lifestyle Decor
    ('ba666666-6666-6666-6666-666666666601', 'French Vanilla Scented Soy Bubble Candle', 'french-vanilla-soy-bubble-candle', 'Hand-poured 100% natural soy wax bubble cube candle scented with warm French vanilla and Madagascar amber. Clean-burning and serves as an aesthetic room decor accent.', 'c6666666-6666-6666-6666-666666666666', 850, 1250, 24, 4, TRUE, TRUE, FALSE, 4.9, 53),
    ('ba666666-6666-6666-6666-666666666602', 'Glass Aesthetic Tumbler with Glass Straw (500ml)', 'glass-aesthetic-tumbler-straw-500ml', 'Borosilicate clear glass iced coffee can tumbler with natural bamboo lid and reusable curved glass straw. Heat and cold resistant for iced coffees, boba, and matcha lattes.', 'c6666666-6666-6666-6666-666666666666', 1150, 1600, 19, 4, TRUE, FALSE, TRUE, 4.9, 44);

-- Insert Product Images
INSERT INTO public.product_images (product_id, image_url, is_primary, display_order)
VALUES
    ('ba111111-1111-1111-1111-111111111101', 'https://images.unsplash.com/photo-1576053139778-7e32f2ae3cfd?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba111111-1111-1111-1111-111111111102', 'https://images.unsplash.com/photo-1606760227091-3dd870d97f1d?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba111111-1111-1111-1111-111111111103', 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    
    ('ba222222-2222-2222-2222-222222222201', 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba222222-2222-2222-2222-222222222202', 'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba222222-2222-2222-2222-222222222203', 'https://images.unsplash.com/photo-1611591475152-4783113f60bc?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba222222-2222-2222-2222-222222222204', 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&auto=format&fit=crop&q=80', TRUE, 1),

    ('ba333333-3333-3333-3333-333333333301', 'https://images.unsplash.com/photo-1616683693504-3ea7e9ad6fec?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba333333-3333-3333-3333-333333333302', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba333333-3333-3333-3333-333333333303', 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&auto=format&fit=crop&q=80', TRUE, 1),

    ('ba444444-4444-4444-4444-444444444401', 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba444444-4444-4444-4444-444444444402', 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba444444-4444-4444-4444-444444444403', 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&auto=format&fit=crop&q=80', TRUE, 1),

    ('ba555555-5555-5555-5555-555555555501', 'https://images.unsplash.com/photo-1583485088034-697b5bc54ccd?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba555555-5555-5555-5555-555555555502', 'https://images.unsplash.com/photo-1585776245991-cf89dd7fc73a?w=800&auto=format&fit=crop&q=80', TRUE, 1),

    ('ba666666-6666-6666-6666-666666666601', 'https://images.unsplash.com/photo-1603006905003-be475563bc59?w=800&auto=format&fit=crop&q=80', TRUE, 1),
    ('ba666666-6666-6666-6666-666666666602', 'https://images.unsplash.com/photo-1577741314755-048d8525d31e?w=800&auto=format&fit=crop&q=80', TRUE, 1);

-- Insert Product Variants
INSERT INTO public.product_variants (product_id, name, options, price_modifier, stock_quantity)
VALUES
    ('ba111111-1111-1111-1111-111111111101', 'Color Theme', '["Pastel Dream (Pink, Mauve, Sage)", "Neutral Classic (Black, Beige, Cream)", "Jewel Tone (Emerald, Ruby, Navy)"]'::JSONB, 0, 45),
    ('ba111111-1111-1111-1111-111111111102', 'Color Palette', '["Matte Pastel (Nude, Sage, Blush)", "Monochrome (Black, Tortoise, White)"]'::JSONB, 0, 30),
    ('ba111111-1111-1111-1111-111111111103', 'Frame Color', '["Classic Black", "Vintage Tortoiseshell", "Champagne Gold"]'::JSONB, 0, 18),
    ('ba222222-2222-2222-2222-222222222201', 'Metal Finish', '["18K Gold Plated", "Silver Rhodium Plated"]'::JSONB, 0, 25),
    ('ba444444-4444-4444-4444-444444444401', 'Color', '["Beige Cream", "Sage Green", "Dusty Pink", "Mocha Brown"]'::JSONB, 0, 20),
    ('ba444444-4444-4444-4444-444444444402', 'Pattern', '["Blush Pink Cloud", "Cream Floral Quilted", "Sage Green Grid"]'::JSONB, 0, 28),
    ('ba444444-4444-4444-4444-444444444403', 'Box Color', '["Blush Pink", "Snow White", "Emerald Velvet", "Mocha Nude"]'::JSONB, 0, 16),
    ('ba666666-6666-6666-6666-666666666601', 'Fragrance', '["French Vanilla", "Wild Jasmine & Bergamot", "Warm Sandalwood"]'::JSONB, 0, 24);
